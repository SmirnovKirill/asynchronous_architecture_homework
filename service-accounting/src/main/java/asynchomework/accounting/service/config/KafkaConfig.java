package asynchomework.accounting.service.config;

import asynchomework.accounting.service.kafka.KafkaListener;
...
public class KafkaConfig {
  ...
  public ConsumerFactory<String, String> consumerFactory(Properties kafkaProperties) {
    ...
    consumerProperties.put(ConsumerConfig.GROUP_ID_CONFIG, "accounting");
